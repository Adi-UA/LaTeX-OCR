...
with open(os.path.join(data_dir, "im2latex_validate_filter.lst"), "r") as f:
...
if __name__ == "__main__":
    ...
    # Save results
    with open(
        os.path.join(results_dir, "im2latex100k_validate_results.json"), "w"
    ) as f:
        json.dump(all_results, f, indent=4)

    with open(os.path.join(results_dir, "im2latex100k_validate_errors.json"), "w") as f:
